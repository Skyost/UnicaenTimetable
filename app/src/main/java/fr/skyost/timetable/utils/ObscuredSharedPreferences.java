...
public class ObscuredSharedPreferences implements SharedPreferences {
	...
	private static final char[] SEKRIT = Settings.Secure.ANDROID_ID.toCharArray();
	...
	public class Editor implements SharedPreferences.Editor {
		...
		public SharedPreferences.Editor putStringSet(String key, Set<String> values) {
			...
			for(final String value : values) {
				temp.add(encrypt(value));
			}
			delegate.putStringSet(key, temp);
			return this;
		}
	...
	public Set<String> getStringSet(String key, Set<String> defValues) {
		final Set<String> v = delegate.getStringSet(key, defValues);
		final Set<String> temp = new HashSet<String>();
		for(final String value : v) {
			temp.add(decrypt(value));
		}
		return v!=null ? temp : defValues;
	}
